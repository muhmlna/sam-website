...
// import TitleBg from "../../images/pricing/Hero.png";
      ...
      >
        ...
        >
          ...
          <div className="text-white gap-7 flex mr-7 ">
            <a href="https://www.tiktok.com/@sam.reworks?_t=8o5cfcd1lst&_r=1" target="_blank" rel="noopener noreferrer" className="fa-brands rotate-90 hover:text-[#FF0336] fa-tiktok text-3xl cursor-pointer ease-in duration-200 "></a>
            <a href="https://www.instagram.com/sam.reworks/" target="_blank" rel="noopener noreferrer" className="fa-brands rotate-90 hover:text-[#FF0336] fa-instagram text-3xl cursor-pointer ease-in duration-200"></a>
          </div>
        </div>
      </section>
    </>
